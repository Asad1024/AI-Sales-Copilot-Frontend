...
export function StatusFieldHelper({ baseId, onCreated }: StatusFieldHelperProps) {
  ...
  return (
    <div style={{ marginTop: "24px", padding: "20px", background: "rgba(37, 99, 235, 0.05)", borderRadius: "12px", border: "1px solid rgba(37, 99, 235, 0.2)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
        <Icons.Lightbulb size={20} style={{ color: "#2563EB" }} />
