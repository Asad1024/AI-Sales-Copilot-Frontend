              ...
              return (
                <tr 
                  ...
                  style={{ 
                    ...
                    cursor:'pointer',
                    background: selectedLeads.includes(lead.id) ? 'rgba(124, 58, 237, 0.1)' : 'transparent',
                ...
                >
                    ...
                    <div>
                      ...
                      {phoneInfo.normalized && (
                        <div style={{ fontSize: '12px', color: 'var(--color-text-muted)', display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap', marginTop: '4px' }}>
                          <span>📞</span>
                          <a href={`tel:${phoneInfo.normalized}`} style={{ color: '#7C3AED', textDecoration: 'none' }}>
                            {phoneInfo.normalized}
                          </a>
                          {phoneSourceBadge && (
                            <span style={{
                  ...
                  <td style={{ padding: '16px 12px' }}>
                    <div style={{
                      background: (lead.score || 0) > 80 ? 'linear-gradient(135deg, #7C3AED 0%, #A94CFF 100%)' : 
