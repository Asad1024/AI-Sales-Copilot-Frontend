...
export function ColumnConfigPanel({ type, config, onChange, columnId }: ColumnConfigPanelProps) {
  ...
  const defaultColors = ["#4C67FF", "#ff6b6b", "#4ecdc4", "#ffa726", "#66bb6a", "#ef5350", "#ab47bc", "#26c6da"];
  ...
  if (type === "status") {
    return (
      <div>
            ...
            >
              <div
                style={{
                  ...
                  height: "24px",
                  borderRadius: "50%",
                  background: option.color || "#4C67FF",
                  border: `2px solid ${option.color || "#4C67FF"}80`,
                  cursor: "pointer",
                }}
                onClick={() => {
                  const input = document.createElement("input");
                  input.type = "color";
                  input.value = option.color || "#4C67FF";
                  input.onchange = (e) => {
        ...
        {options.length > 0 && (
          <div style={{ marginTop: "12px", padding: "12px", background: "rgba(76, 103, 255, 0.05)", borderRadius: "8px" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
              {options.map((opt: any, idx: number) => (
                <span
                  key={idx}
                  style={{
                    background: `${opt.color || "#4C67FF"}20`,
                    color: opt.color || "#4C67FF",
                    padding: "4px 12px",
                    borderRadius: "6px",
                    fontSize: "12px",
                    fontWeight: "600",
                    border: `1px solid ${opt.color || "#4C67FF"}40`,
                    display: "inline-flex",
                    alignItems: "center",
                    gap: "6px",
                  }}
    ...
    return (
      <div>
        ...
        {normalizedOptions.length === 0 && (
          <div style={{ padding: "16px", background: "rgba(76, 103, 255, 0.05)", borderRadius: "8px", border: "1px dashed rgba(76, 103, 255, 0.3)" }}>
        ...
        {normalizedOptions.length > 0 && (
          <div style={{ marginTop: "16px", padding: "16px", background: "rgba(76, 103, 255, 0.05)", borderRadius: "8px", border: "1px solid rgba(76, 103, 255, 0.2)" }}>
