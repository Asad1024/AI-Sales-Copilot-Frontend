...
export default function TestConfigurationPage() {
  ...
  const runChannelTest = async (channel: "linkedin" | "whatsapp") => {
    ...
    try {
      ...
      showSuccess("Channel test", response?.message || `${channel} test successful.`);
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <BaseCard style={{ padding: "22px 24px" }}>
        ...
        <p style={{ fontSize: 13, color: "var(--color-text-muted)", margin: 0, lineHeight: 1.5, maxWidth: 560 }}>
          Run safe checks against your current backend configuration. Each flow opens a short form — no text-only
      ...
      {showTestLinkedInModal && (
        ...
        >
          ...
          <BaseCard style={{ width: "min(520px, 100%)", padding: 24 }}>
            ...
            <p style={{ margin: "0 0 12px", fontSize: 13, color: "var(--color-text-muted)" }}>Profile URL for integration check.</p>
            <input
              type="text"
      ...
      {showTestWhatsAppModal && (
        ...
        >
          ...
          <BaseCard style={{ width: "min(520px, 100%)", padding: 24 }}>
            ...
            <p style={{ margin: "0 0 12px", fontSize: 13, color: "var(--color-text-muted)" }}>Number with country code.</p>
            <input
              type="text"
