                ...
                return (
                  <button
                    ...
                    style={{
                      padding: '16px',
                      borderRadius: 12,
                      border: isSelected ? '2px solid #4C67FF' : '1px solid var(--elev-border)',
                      background: isSelected ? 'rgba(76, 103, 255, 0.1)' : 'var(--elev-bg)',
                      display: 'flex',
                  ...
                  >
                    <IconComponent size={24} style={{ color: isSelected ? '#4C67FF' : 'var(--color-text)' }} />
